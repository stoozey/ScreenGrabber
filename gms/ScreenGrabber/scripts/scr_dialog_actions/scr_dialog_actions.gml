...
{
	RunFunction: function() { execute_shell("\"post_call.exe\" copy_to_clipboard \"" + SCREENSHOT_DIR + "\"", false); game_end(); },
...
{
	RunFunction: function() { execute_shell("\"post_call.exe\" save_to_file \"" + SCREENSHOT_DIR + "\"", false); game_end(); },
